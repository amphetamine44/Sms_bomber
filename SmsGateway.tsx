...
const PROVIDERS: Provider[] = [
  ...
  },
  {
    ...
    name: 'Twilio',
    countries: ['Global (200+ countries)'],
    endpoint: (creds: Record<string, string>) =>
    ...
    bodyTemplate: (creds, phone, message) => {
      ...
      // Use MessagingServiceSid if provided, otherwise From
  ...
  const send = async (providers: Provider[], phone: string, message: string, creds: Record<string, string>) => {
    ...
    for (const provider of providers) {
      try {
        ...
        // Add extra fields for each provider
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Provide either a From number or a Messaging Service SID.</p>
                </div>
                <div className="space-y-2">
